...
import 'package:test_project/local_provider_with_nested_routes/provider_notifier.dart';
...
class SetupFlowState extends State<SetupFlow> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: ChangeNotifierProvider<ProviderNotifier>(
                ...
                builder: (context, provider, child) {
                  return Column(
                    children: [
                      Text(provider.value),
                      TextButton(
                          onPressed: provider.updateValue,
